...
public class BoardDAO {
	...
	public ArrayList<BoardDTO> getBoardList(int page, int limit, String items, String text) {
		...
		try {
			...
			while (rs.absolute(index)) {
				...
				board.setB_key(rs.getString("b_key"));
	...
	public void insertBoard(BoardDTO board)  {
		...
		try {
			...
			pstmt.setString(9, board.getB_key());
	...
	public void updateBoard(BoardDTO board) {
		...
		try {
			String sql = "update board set name=?, subject=?, content=,? b_key=? , where num=?";
			...
			pstmt.setString(5, board.getB_key());
	...
	public void deleteBoard(int id) {
		...
		String sql = "update board set num =0 where id=?";	
