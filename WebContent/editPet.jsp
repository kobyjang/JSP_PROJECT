...
<head>
	...
	function deleteConfirm(id) {
		if (confirm("해당 상품을 삭제합니다!!") == true)
			location.href = "./deletePet.jsp?id=" + id;
		else
			return;
	}
</script>
...
<body>
	...
	<div class="container">
		<div class="row justify-content-center" align="center">
			...
			%>
			<div class="col-md-3">
				<img src="resources/images/<%=rs.getString("fileName")%>" style="height: 200px", width="200px">
				<h3><%=rs.getString("Aname")%></h3>
				<p><%=rs.getString("sex")%>
				<p><%=rs.getString("Atype")%>
				<p><%=rs.getString("dutyPrice")%>원
				<p><%
						if (edit.equals("update")) {
					%>
					<a href="./updatePet.jsp?id=<%=rs.getString("id")%>" class="btn btn-success" role="button"> 수정 &raquo;></a>
					<%
