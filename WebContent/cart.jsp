    ...
    <div class="container py-5">
		...
		<div style="padding-top: 50px">
			<table class="table table-hover">
				...
				%>
				<tr>
					<td><%=pet.getPetId()%> - <%=pet.getAname()%></td>
					<td><%=pet.getDutyPrice()%></td>
					<td><%=pet.getQuantity()%></td>
					<td><%=total%></td>
					<td><a href="./removeCart.jsp?id=<%=pet.getPetId()%>" class="badge badge-danger">삭제</a></td>
				</tr>
				<%
					}
				%>
			...
			<a href="./pets.jsp" class="btn btn-secondary"> &laquo; 쇼핑 계속하기</a>
		</div>
		<hr>
	</div>
    </div>
