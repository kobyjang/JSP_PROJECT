            ...
            <div class="container py-5">
                <div class="row">
                    <div class="container" align="center">
                        <h1 class="display-3">아기 목록</h1>
                    </div>
                </div>
                <div class="container">
                    <div class="row justify-content-center" align="center">
                        <%@ include file="dbconn.jsp" %>
                            <% PreparedStatement pstmt=null; ResultSet rs=null; String sql="select * from pet" ;
                                pstmt=conn.prepareStatement(sql); rs=pstmt.executeQuery(); while (rs.next()) { %>
                                <div class="col-md-3">
                                    <img src="resources/images/<%=rs.getString("fileName")%>" style="height: 200px",
                                    width="200px">
                                    <h3>
                                        <%=rs.getString("Aname")%>
                                    </h3>
                                    <p>
                                        <%=rs.getString("sex")%>
                                            <p>
                                                <%=rs.getString("Atype")%>
                                                    <p>
                                                        <%=rs.getString("dutyPrice")%>원
                                                            <p><a href="./pet.jsp?id=<%=rs.getString("id")%>"class="btn
                                                                    btn-secondary" role="button">상세 정보 &raquo;></a>
                                </div>
