...
<body>
	...
	<div class="container">
		<form name="newMember" class="form-horizontal" id="server" action="processAddMember.jsp" method="post" onsubmit="return checkForm()">
			<div class="form-group  row">
				<label class="col-sm-2 ">아이디</label>
				<div class="col-sm-3">
				<div class="d-flex justify-content-end">
					<input name="id" type="text" class="form-control" placeholder="id" id="id" onkeydown="inputIdChk()">
					<div id="here"></div>
				</div>		
				</div>
			</div>
			...
			<div class="form-group  row">
				...
				<div class="col-sm-5">
					<div class="d-flex justify-content-end">
					<input name="address"id="address" type="text" class="form-control" placeholder="address" required readonly/>
	...
	function goPopup(){
		...
		var pop =window.open("/WebMarket/address/jusoPopup.jsp","pop","width=570,height=420, scrollbars=yes, resizable=yes"); 
