...
<head>
    ...
    <% String shipping_cartId="" ; String shipping_name="" ; String shipping_shippingDate="" ; String
        shipping_country="" ; String shipping_zipCode="" ; String shipping_addressName="" ; Cookie[]
        cookies=request.getCookies(); if (cookies !=null) { for (int i=0; i < cookies.length; i++) { Cookie
        thisCookie=cookies[i]; String n=thisCookie.getName(); if (n.equals("Shipping_cartId"))
        shipping_cartId=URLDecoder.decode((thisCookie.getValue()), "utf-8" ); if
    ...
    <div class="container py-5">
        <div class="row">
            <div class="container" align="center">
                <h1 class="display-3">분양 완료</h1>
            </div>
        </div>
        <div class="container">
            <h2 class="alert alert-danger">분양해주셔서 감사합니다.</h2>
            <p>아기는 <% out.println(shipping_shippingDate); %>에 전달될 예정입니다! !
                    <p>분양번호 : <% out.println(shipping_cartId); %>
        </div>
        <div class="container">
            <p><a href="./pets.jsp" class="btn btn-secondary"> &laquo; 아기 목록</a>
        </div>
    </div>
    <!-- Start Footer -->
